...
$consulta = "SELECT id_usuario FROM usuarios ORDER BY id_usuario";
//Ejecuto el query
...
{
	echo "<option value='".utf8_encode($registro["id_usuario"])."'";
	if($_GET["user_slc"]==$registro["id_usuario"])
	{
		echo " selected";	
	}
	echo ">".utf8_encode($registro["id_usuario"])."</option>";
}
//$conexion->close();
?>